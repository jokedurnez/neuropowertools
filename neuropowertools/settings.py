...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "neuropowertools", "templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'neuropowertools', 'static')
]
STATIC_ROOT = os.path.join(BASE_DIR, 'neuropowertools', 'assets')